-- Salidas: evaluar desde el 7 de septiembre de 2026. No modifica marcaciones.
-- Aplicar despues de dashboard_54. Los otros criterios conservan sus reglas.
begin;
...
begin
  ...
  with calendario as materialized (
    ...
    select d.*,ev.*,
      ...
      incorporado and trabajo and fecha>=date '2026-09-07' and estado in ('P','T') and salida_at between
    ...
    select id,
      ...
      count(*) filter(where trabajo and fecha>=date '2026-09-07') salidas_mes,
