...
(function(){
  ...
  const TIPOS = {
    taller:{
      plantilla:'Certificado_taller/PLANTILLA_CERTIFICADO_TALLER.webp?v=5',
    ...
    curso:{
      plantilla:'Certificado_cursos/PLANTILLA_CERTIFICADO_CURSOS.webp?v=4',
    ...
    especializacion:{
      plantilla:'Certiicado_curso_especializacion/PLANTILLA_CERTIFICADO_CURSO_ESPECIALIZACION.webp?v=4',
    ...
    constancia:{
      plantilla:'Certificado_constancia_taller_presencial/PLANTILLA_CERTIFICADO_TALLER_PRESENCIAL.webp?v=4',
      etiquetaTitulo:'Nombre del taller', fechas:'simple',
