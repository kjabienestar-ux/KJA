...
(function(){
  ...
  const TIPOS = {
    taller:{
      plantilla:'Certificado_taller/PLANTILLA_CERTIFICADO_TALLER.webp?v=4',
    ...
    curso:{
      plantilla:'Certificado_cursos/PLANTILLA_CERTIFICADO_CURSOS.webp?v=3',
    ...
    especializacion:{
      plantilla:'Certiicado_curso_especializacion/PLANTILLA_CERTIFICADO_CURSO_ESPECIALIZACION.webp?v=3',
    ...
    constancia:{
      plantilla:'Certificado_constancia_taller_presencial/PLANTILLA_CERTIFICADO_TALLER_PRESENCIAL.webp?v=3',
      etiquetaTitulo:'Nombre del taller', fechas:'simple',
